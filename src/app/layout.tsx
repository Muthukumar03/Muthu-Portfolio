...
export const metadata: Metadata = {
  title: "Muthukumar G — UI/UX & Product Designer",
  description:
    "Portfolio of Muthukumar G — UI/UX Designer with 2+ years of experience in user research, wireframing, prototyping, design systems, and Blender 3D.",
  icons: {
